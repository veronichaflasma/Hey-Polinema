          ...
          <div class="row justify-content-center">
            <div class="col-12">
              <div class="row align-items-center my-4">
                <div class="col">
                  <h2 class="h3 mb-0 page-title">Friend List</h2>
                </div>
              </div>
              <div class="row">
                <div class="col-md-3">
                  <div class="card shadow mb-4">
                    <div class="card-body text-center">
                      ...
                      <div class="card-text my-2">
                        <strong class="card-title my-0">Hailey Bieber </strong>
                        <p class="small text-muted mb-0">Programmer</p>
                        <p class="small"><span class="badge badge-light text-muted">Malang, IDN</span></p>
                      </div>
                    </div> <!-- ./card-text -->
